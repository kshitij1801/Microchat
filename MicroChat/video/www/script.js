...
const ICE_SERVERS = [
	...
	{ urls: "turn:numb.viagenie.ca", username: "kshitijsinghal.1801@gmail.com", credential: "d0ntuseme" },
	{
		urls: [
...
const APP_URL = (() => {
	...
	return protocol + location.hostname + (location.hostname == "localhost" ? ":4000" : "");
})();
